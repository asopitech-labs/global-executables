...
The generated data contract is published from the orphan `dictionary` branch;
`main` owns the generator and schemas and intentionally does not track generated
dictionary files. `data/executables/**` is the sole canonical dataset. `data/indexes/**` and
...
The stable raw-data base URL is
`https://raw.githubusercontent.com/asopitech-labs/global-executables/dictionary`.
See [`DICTIONARY_BRANCH.md`](DICTIONARY_BRANCH.md) for lifecycle and migration
details.
